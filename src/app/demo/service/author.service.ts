...
export class AuthorService {
    ...
    getAll(): Observable<any> {
        return this.apiService.getAll(this.AUTHOR_PATH).pipe(
            map((res) => {
                if (res) {
                    return res;
                } else {
    ...
    findAllByName(name) {
        return this.apiService
            .findAllByName(this.AUTHOR_PATH + this.FIND_ALL_BY_NAME_PATH + name)
            .pipe(
                map((res) => {
                    if (res) {
                        return res;
    ...
    getById(id: number): Observable<any> {
        return this.apiService.getById(this.AUTHOR_PATH + '/' + id).pipe(
            map((res) => {
                if (res) {
                    return res;
                } else {
    ...
    post(author): Observable<any> {
        return this.apiService.post(this.AUTHOR_PATH, author).pipe(
            map((res) => {
                if (res) {
                    return res;
                } else {
    ...
    put(id, author): Observable<any> {
        return this.apiService.put(this.AUTHOR_PATH + '/' + id, author).pipe(
            map((res) => {
                if (res) {
                    return res;
                } else {
    ...
    delete(id): Observable<any> {
        return this.apiService.delete(this.AUTHOR_PATH + '/' + id).pipe(
            map((res) => {
                if (res) {
                    return res;
                } else {
    ...
    getPage(pagination: PaginationDto, searchAuthorDto: SearchAuthorDto) {
        ...
        return this.apiService
            .getAll(
                `${this.AUTHOR_PATH}/get/page?page=${pagination.page}&size=${pagination.size}${conditionStr}`
            )
            .pipe(
                map((res) => {
                    if (res) {
    ...
    getList(pagination: PaginationDto, searchAuthorDto: SearchAuthorDto) {
        ...
        return this.apiService
            .postBody(this.AUTHOR_PATH + '/search', dataBody)
            .pipe(
                map((res) => {
                    if (res) {
                        return res;
