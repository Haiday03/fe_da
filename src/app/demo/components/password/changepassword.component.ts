...
export class changepasswordComponent implements OnInit{
    ...
    updatePassword(){
      ...
      if(this.PasswordUpdateForm.value['newpassword'] === this.PasswordUpdateForm.value['newpassword2']){
        ...
        this.messageService.add({ severity: 'success', summary: 'Thành công!', detail: 'Mật khẩu của bạn đã được cập nhật', life: 3000 });
        this.router.navigate(['/auth/login']);
      } else {
        this.messageService.add({ severity: 'error', summary: 'Thất bại!', detail: 'Bạn đã nhập sai mật khẩu hiện tại của mình', life: 3000 });
      }
    }
