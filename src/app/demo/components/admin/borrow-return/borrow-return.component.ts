...
export class BorrowReturnComponent { 
    ...
    constructor(private messageService: MessageService, private borrowService: BorrowService, private excelApiService: ExcelApiService) { }
    ...
    fetchPaging(){
        this.borrowService.getBorrowPage(this.pagination, this.searchBorrowedHistoryDto).subscribe(
            data => {
    ...
    exportExcel() {
        this.borrowService.exportToExcel(this.searchBorrowedHistoryDto).subscribe(
            () => {
